...
public class FileInfoDaoSqls {
	...
	public static final String SELECT_ALL = "SELECT id, name FROM file_info ORDER BY id";
	
//	public static final String UPDATE = "UPDATE file_info set name = :name WHERE id = :id";
	
	public static final String SELETE_BY_ID = "SELECT id, name FROM file_info ORDER BY id WHERE id = :id";
