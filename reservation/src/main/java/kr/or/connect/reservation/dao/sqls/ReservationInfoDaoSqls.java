...
public class ReservationInfoDaoSqls {
	...
	public static final String SELETE_BY_ID = "SELECT id, product_id, display_info_id, reservation_name, reservation_tel, reservation_email, reservation_date, cancel_flag, create_date, modify_date FROM reservation_info WHERE id = :id";

	public static final String DELETE_BY_ID = "DELETE FROM reservation_info WHERE id = :id";

	public static final String DELETE_BY_PRODUCT_ID = "DELETE FROM reservation_info WHERE product_id = :productId";
